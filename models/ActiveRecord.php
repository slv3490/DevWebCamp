...
class ActiveRecord {
    ...
    //Obtener un limite de registros
    public static function paginar($limite, $offset) {
        $query = "SELECT * FROM " . static::$tabla . " ORDER BY id DESC LIMIT ${limite} OFFSET ${offset}" ;
        $resultado = self::consultarSQL($query);
        return $resultado;
    }
    ...
    //Retornar por orden y un limite
